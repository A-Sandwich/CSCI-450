...
if(isset($_POST['carName'], $_POST['mileage'], $_POST['carMake'], $_POST['carModel'], $_POST['carYear'], $_POST['carColor'], $_POST['vin'], $_POST['engineType'])) {
	...
	$check_car_exists_query = $mysqli->prepare('SELECT ID FROM cars WHERE Make = ? AND Model = ? AND Year = ? LIMIT 1');
	$check_car_exists_query->bind_param('ssi', $carMake, $carModel, $carYear);
