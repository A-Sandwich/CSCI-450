	...
	<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="#about">Update Mpg</a></li>
						<li><a href="#contact">Add a repair</a></li>
					</ul>
				</div><!-- /.nav-collapse -->
			</div><!-- /.container -->
		</div><!-- /.navbar -->
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<div class="jumbotron">
				<h1>Welcome to Novus Garage!</h1>
				<p>Novus Garage is great new web app to help you manage your cars. You can track things such as mpg and repairs for all your cars!</p>
        </div>
        
		<div class="row">
			<div class="col-6 col-sm-6 col-lg-4">
				<h2>Recent car activity (Date)</h2>
